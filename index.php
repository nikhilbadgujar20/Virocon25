...
<div class="modal fade" id="pdfModal" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body"><iframe id="pdfFrame" src="#" width="100%" height="500px"></iframe></div>
		</div>
	</div>
</div>
<section id="advertisers" class="advertisers-service-sec pt-5 pb-5">
	<div class="container">
		...
		<div class="row mt-5 mt-md-4 row-cols-1 row-cols-sm-1 row-cols-md-3 justify-content-center">
			<div class="col"><a href="conference information.php">
					<div class="service-card">
						<div class="icon-wrapper"><i class="fa-solid fa-chart-line"></i></div>
						<h3>Conference Information<h3>
					</div>
			</div>
			<div class="col"><a href="404_page.php">
					<div class="service-card">
						<div class="icon-wrapper"><i class="fa-solid fa-arrows-down-to-people"></i></div>
				...
				<div class="content-block">
					...
					<div class="description-one">
						...
						<p>We are confi dent that the conference will provide an excellent platform to the
							...
							would be the joint symposium involving all these specialties, plenary lectures, key note
							talks and invited guest lectures by world renowned scientists along with oral and poster
							presentations. Your participation in the conference would be a great source of
							inspiration for the young researchers and the fellow participants.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="section-title white">
					<h2>Conference <span class="alternate">Date</span></h2>
					<hr>
				</div>
			</div>
		</div>
		<ul class="timeline">
			...
			<li class="timeline-item mb-5">
				...
				<p class="text-muted">Please note that registration is mandatory for all participants attending
					VIROCON – 2025. Ensure you register before the conference to guarantee your participation.</p>
			</li>
			<li class="timeline-item mb-5">
				<h5 class="fw-bold">Call to Action</h5>
				<p class="text-muted">Ready to join us at VIROCON-2025? Register before <strong>30th September,
						2025</strong> to secure your spot and take advantage of early bird rates. We look forward to
					welcoming you!</p>
			</li>
		</ul>
	</div>
